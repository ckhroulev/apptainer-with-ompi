...
- Update to use [[https://openucx.readthedocs.io/en/master/running.html#openmpi-with-ucx][UCX]] (and =libfabric=?).
- Make sure that the list of packages in =base.def= does not include
  anything unnecessary.

* Acknowledgments

This work was inspired by [[https://blogs.ed.ac.uk/mhagdorn/2020/08/14/using-singularity-to-containerise-a-scientific-model/][a blog post by Magnus Hagdorn at the
...
by the [[https://youtu.be/jl2cT9gkxwo][recording of the 2022-1-6 Singularity CE community meeting]].
